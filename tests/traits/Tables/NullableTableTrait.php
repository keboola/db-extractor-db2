...
trait NullableTableTrait
{
    ...
    private function getNullableTableRows(): array
    {
        return [
            ...
            'data' => [
                [1, 'luigi', '2012-01-10', '2021-01-05 13:43:12.123', '2021-01-05 13:43:12.123'],
                [2, 'toad', '2012-01-10', '2021-01-05 13:43:13.456', '2021-01-05 13:43:13.456'],
                [null, null, null, null, '2021-01-05 13:43:14.489'],
            ],
        ];
    }

    private function getNullableTableColumns(string $datetimeType = 'TIMESTAMP'): array
    {
        return [
            'id' => 'INT DEFAULT NULL',
            'name' => 'VARCHAR(55) DEFAULT NULL',
            'smalldatetime' => 'DATE DEFAULT NULL',
